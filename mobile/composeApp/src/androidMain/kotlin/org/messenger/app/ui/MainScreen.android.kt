...
actual fun PlatformMainScreen(
    ...
    // На Android используется стековая навигация в App.kt — этот expect не вызывается.
    // Заглушка нужна только для компиляции actual.
    MobileMainScreenStub()
}

@Composable
private fun MobileMainScreenStub() {}